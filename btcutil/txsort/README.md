...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/msvprogs/btcd/btcutil/txsort)
...
```bash
$ go get -u github.com/msvprogs/btcd/btcutil/txsort
```

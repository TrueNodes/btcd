...
* Download the Conformal public key:
  https://raw.githubusercontent.com/msvprogs/btcd/master/release/GIT-GPG-KEY-conformal.txt
...
* Install the MSI available at: [btcd windows installer](https://github.com/msvprogs/btcd/releases)
...
```bash
git clone https://github.com/msvprogs/btcd $GOPATH/src/github.com/msvprogs/btcd
...
* [Using bootstrap.dat](https://github.com/msvprogs/btcd/blob/master/docs/configuration.md#using-bootstrapdat)

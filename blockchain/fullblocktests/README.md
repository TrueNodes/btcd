...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/msvprogs/btcd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/msvprogs/btcd/blockchain/fullblocktests
```
